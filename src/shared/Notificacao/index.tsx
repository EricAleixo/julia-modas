...
export const Notificacao = () => {
    ...
    return (
        mostrar && (
            <motion.div
                id="marketing-banner"
                className="fixed z-50 flex flex-col md:flex-row justify-between items-center w-[calc(100%-2rem)] p-4 bg-white border border-gray-100 rounded-lg shadow-sm lg:max-w-7xl left-1/2 top-6 transform -translate-x-1/2"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            >
                <div className="flex flex-col items-start mb-3 me-4 md:items-center md:flex-row md:mb-0">
                    ...
                    <p className="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
                        Ainda não se cadastrou? Faça um cadastro e aproveite!
                    </p>
                </div>
                <div className="flex items-center flex-shrink-0">
                    <Link
                        to="/login"
                        className="px-5 py-2 me-2 text-xs font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 focus:outline-none"
                    >
                        Acesse
                    </Link>
                    <button
