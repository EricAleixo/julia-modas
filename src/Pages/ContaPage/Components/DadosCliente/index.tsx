        ...
        <tr>
            ...
            <td className="h-px w-72 whitespace-nowrap">
                <div className="px-6 py-3">
                    <span className="block text-sm font-semibold text-gray-800">azul20264552</span>
                </div>
            </td>
            <td className="size-px whitespace-nowrap">
                <div className="px-6 py-3">
            ...
            <td className="size-px whitespace-nowrap">
                <div className="px-6 py-3">
                    <div className="flex items-center gap-x-3">
                        <span className="text-xs text-gray-900 font-bold">5</span>
                    </div>
                </div>
            </td>
            <td className="size-px whitespace-nowrap">
                <div className="px-6 py-3">
                    <span className="text-sm text-gray-500">18 Dez, 15:20</span>
                </div>
            </td>
            <td className="size-px whitespace-nowrap">
